...
// 5.4             // numeric literal expression
...
// let anExpression = Math.PI + (4 / 6) * 6
...
//  STEP 5 
// Take the 3 of the variables, declaring and assigning values to them
// let firstName = 'Trish'
...
// STEP 7 Second variable, add a number and a Boolean and display the coerced result
// let firstName = 'Trish'
// let numDogs = 0;
...
// alert('Hello ' + student + ',  welcome to the' + course + ' class!')

//  STEP 14  *** not sure I used my name etc instead of Zac's a bit unclear
...
// let result = window.prompt("Enter your first name")
